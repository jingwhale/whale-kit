    ...
    return (
      <div className={styles.body}>
        <Typography>
          ...
          <div className={styles.paragraph}>
            <Paragraph>
              <Text code>组件交互标注</Text> 包括 <Text code>获得数据</Text>（Input、TextArea等） 、 <Text code>改变数据项</Text>（Select、Radio、RadioGroup、CheckBox、CheckBoxGroup等） 、 <Text code>展示数据</Text> （Table、Img标签等）、 <Text code>功能</Text>（Button、A标签等），四种类型，每种类型包含基本标注项如下：
            </Paragraph>
            <Collapse>
