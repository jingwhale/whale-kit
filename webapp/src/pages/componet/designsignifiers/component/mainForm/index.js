      ...
      <Form {...formItemLayout} onSubmit={this.handleSubmit}>
        ...
        >
          {getFieldDecorator('state', {
            rules: [{ required: true, message: '请选择当前页面的状态!' }],
          })(
            <Radio.Group>
              <Radio value="a">正常访问</Radio>
              <Radio value="b">网络状态不佳</Radio>
              <Radio value="c">无权限</Radio>
              <Radio value="d">404</Radio>
            </Radio.Group>
          )}
        </Form.Item>
        <Form.Item
        ...
        >
          {getFieldDecorator('stateDescription', {
            rules: [{ required: true, message: '请添加页面状态描述!' }],
          })(
            <AutoComplete
        ...
        >
          {getFieldDecorator('linkin', {
            rules: [{ required: true, message: '请添加页面的入口!' }],
          })(
            <AutoComplete
              onChange={this.handleWebsiteChange}
        ...
        >
          {getFieldDecorator('linkout', {
            rules: [{ required: true, message: '请添加页面的出口!' }],
          })(
            <AutoComplete
              onChange={this.handleWebsiteChange}
