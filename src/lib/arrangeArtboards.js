...
export function DrawArtboards(artboards,x,y,horizontalGutter,verticalGutter){
    var incrementY = 0;
...
export function DrawArtboardsRows(artboards,x,y,horizontalGutter,verticalGutter){
    var incrementX = 0;
...
export function getDescendants(nodeName){
    var descendants = [];
...
export function getBrothers(nodeName){
    var brothers = [];
...
export function sortArtboardsFunction(a, b) {
    if (a.name() === b.name()) {
        return 0;
    }
    else {
...
export function ShowConfirmation(context, message)
{
