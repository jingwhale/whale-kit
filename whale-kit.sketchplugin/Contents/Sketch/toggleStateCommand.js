...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/toggleStateCommand.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var tinycolor2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tinycolor2 */ "./node_modules/_tinycolor2@1.4.1@tinycolor2/tinycolor.js");
...
var setStateColor = function setStateColor(style, name) {
  ...
  sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message(nowState + "!");
}; //循环属性数组,change color


var doColor = function doColor(name, styleName) {
...
var doTextColor = function doTextColor(style) {
  setStateColor(style, "textColor");
}; //获取fills、borders属性数组,调用doColor change color


var changeColor = function changeColor(layer) {
...
var changeTextColor = function changeTextColor(layer) {
  var textColor = layer.style.textColor;
  textColor && doTextColor(layer.style);
}; //判断layer的不同类型,调用不同的处理函数


var doToggleState = function doToggleState(layer) {
  if (layer.type == "ShapePath" || layer.type == "Shape") {
    ...
    sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message("Please select with Group 、Text or ShapePath type!");
  }
}; //处理单个图层


var doSelectionSingle = function doSelectionSingle(layer) {
  doToggleState(layer);
}; //处理图层组


var doSelectionGrop = function doSelectionGrop(selection) {
  selection.forEach(function (layer) {
    return doSelectionSingle(layer);
  });
}; //判断图层的数量,调用不同的方法处理


var doSelection = function doSelection(selection) {
...
var changeState = function changeState() {
  if (selection) {
    ...
    sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message("State changed to " + nowState + "!");
  } else {
    sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message("Please select a layer or layers!");
  }
};
...
function onRun() {
  sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.getInputFromUser("Please select the status you want to change to:", {
    ...
    if (err) {
      sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message(err);
      return;
    }
  });
}
...
//# sourceMappingURL=toggleStateCommand.js.map