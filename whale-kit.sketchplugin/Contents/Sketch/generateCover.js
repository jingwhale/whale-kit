...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/generateCover.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var sketch_module_web_view_remote__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! sketch-module-web-view/remote */ "./node_modules/_sketch-module-web-view@2.1.7@sketch-module-web-view/remote.js");
...
/* harmony import */ var sketch_module_web_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! sketch-module-web-view */ "./node_modules/_sketch-module-web-view@2.1.7@sketch-module-web-view/lib/index.js");
...
function openPannel() {
  var existingWebview = Object(sketch_module_web_view_remote__WEBPACK_IMPORTED_MODULE_2__["getWebview"])(_lib_config__WEBPACK_IMPORTED_MODULE_1__["identifier"]);
...
function generateHeader(setting) {
  ...
  var rect = new Rectangle(headRect.x, headRect.y, headRect.width, headRect.height); //Create Body(Group)
  ...
  projectName.style.lineHeight = 14; //Create header(Group)-header/projectModule

  var projectModule = new Text({
  ...
  projectModule.style.lineHeight = 14; //Create header(Group)-header/timeTitle

  var timeTitle = new Text({
    text: 'Last Modified',
    frame: {
      x: headRect.width - 80,
      y: 9,
  ...
  timeTitle.style.lineHeight = 10; //Create header(Group)-header/time
  ...
  time.style.lineHeight = 10; //Create header(Group)-header/version
  ...
  version.style.lineHeight = 12; //Create header(Group)-header/versionText
...
function generateContent(setting) {
  ...
  var rect = new Rectangle(contentRect.x, contentRect.y, contentRect.width, contentRect.height); //Create content(Group)

  var groupContent = new Group({
    name: 'content',
    parent: artboard,
    frame: rect
  });
  ...
  projectName.style.verticalAlignment = "center";
  projectName.style.fontSize = 46; //Create content(Group)-content/projectDec

  var projectDec = new Text({
    text: "交互方案",
    alignment: Text.Alignment.center,
    frame: {
  ...
  projectDec.style.fontSize = 20; //Create content(Group)-content/projectParticipants

  var projectParticipants = new Text({
...
//# sourceMappingURL=generateCover.js.map