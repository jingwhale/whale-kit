...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/makeLayoutCommand.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var sketch_module_web_view_remote__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! sketch-module-web-view/remote */ "./node_modules/_sketch-module-web-view@2.1.7@sketch-module-web-view/remote.js");
...
var artBoardLayout = function artBoardLayout() {
  var originFrame = {
    x: 0,
    y: 0,
  ...
  buttonRect.frame.width = originFrame.width * 2 + originFrame.width * artBoardTextWidthRate; //Create line1
  ...
  var line1 = new Shape({
    ...
    parent: buttonRect,
    frame: lineFrame1,
    type: sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Types.Line
  }); //Create line2
...
if (!buttonRect) {
  ...
  if (buttonRect.type == "ShapePath" && buttonRect.shapeType == "Rectangle") {
    ...
    var dist = function dist(data, type) {
      var dist = "";
    ...
    var createGrid = function createGrid(data, index, group) {
      //画grid ceil与位置
      var coordinate = {
        //每个ceil的坐标（1，2）
      ...
      if (data.type == 1) {
        ...
        //不等比
        var getCount = function getCount(index, type) {
          var count = 0;

          for (var i = index; i > 0; i--) {
            //根据坐标获取此ceil是单个基本ceil的倍数
            if (type == "x") {
    ...
    var makeLayout = function makeLayout(data) {
      //布局代码
      var frameData = {
        //获取每一个ceil的size；不等比为最小的那个单位size
        width: dist(data, "width"),
        height: dist(data, "height")
      };
      data.frameData = frameData; //Create 最外层Group
      ...
      buttonRect.remove();
      sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Successful layout!");
    };
...
//# sourceMappingURL=makeLayoutCommand.js.map