...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/generateSignifiers.js");
/******/ })
/************************************************************************/
/******/ ({
...
var insertSignifiers = function insertSignifiers(svgObj, parentLayer) {
  var svgGroup = sketch_dom__WEBPACK_IMPORTED_MODULE_1___default.a.createLayerFromData(svgObj.svgXml, 'svg');
  svgGroup.parent = parentLayer;
};

var doPageArtboardFrame = function doPageArtboardFrame(svgObj) {
...
var doComponentArtboardFrame = function doComponentArtboardFrame(svgObj) {
  var parentGroupFrame = {
...
var adjustArtboardFrame = function adjustArtboardFrame(svgObj) {
  var parentGroup = "";
...
var doSignifiers = function doSignifiers(svgObj) {
...
var setSketchFlag = function setSketchFlag(contents) {
  contents.executeJavaScript("someGlobalFunctionDefinedInTheWebview(".concat(JSON.stringify(sketchFlag), ")")).then(function (res) {
...
function openPannel() {
  var existingWebview = Object(sketch_module_web_view_remote__WEBPACK_IMPORTED_MODULE_4__["getWebview"])(_lib_config__WEBPACK_IMPORTED_MODULE_3__["identifier"]);
  ...
  var win = new sketch_module_web_view__WEBPACK_IMPORTED_MODULE_2___default.a({
    identifier: _lib_config__WEBPACK_IMPORTED_MODULE_3__["identifier"],
    width: 1350,
    height: 800,
...
//# sourceMappingURL=generateSignifiers.js.map