...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/generateRadarChart.js");
/******/ })
/************************************************************************/
/******/ ({
...
selection.forEach(function (layer) {
  return chartRect = layer;
});

var getImageFrame = function getImageFrame(imageData) {
...
var insertImageToArtbord = function insertImageToArtbord(imageData, imageFrame) {
  console.log(imageData);
  console.log(imageFrame); //Create grid group
...
function onRun(context) {
  if (chartRect && chartRect.shapeType == "Rectangle") {
    ...
    //选择一个ArtBord
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Please select an Rectangle!");
  }
}
...
function openPannel() {
  ...
  var Panel = "http://localhost:8000/radarchart.html#".concat(Math.random());
  ...
  contents.on('fromwebview', function (data) {
    getImageFrame(data);
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Successfully screenshot and insert into Rectangle！");
    closeWin();
  });
...
//# sourceMappingURL=generateRadarChart.js.map