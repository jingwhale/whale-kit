...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/screenshotCommand.js");
/******/ })
/************************************************************************/
/******/ ({
...
selection.forEach(function (layer) {
  return artboardRect = layer;
});

var getImageFrame = function getImageFrame(imageSize) {
  var textFrame = {
    x: 0,
...
var insertImageToArtbord = function insertImageToArtbord(imageSize, imageFrame, textFrame) {
  //Create screenshot
  ...
  imageLayer.parent = artboardRect || page; //Create 修订记录
  ...
  text.style.fontWeight = "bold"; //Create 修订记录 link

  var textLink = new Text({
    text: imageSize.url,
    alignment: Text.Alignment.left,
    frame: {
  ...
  textLink.frame.x = imageFrame.x + imageFrame.width - newTextLinkFrame.width; //name artBoard
