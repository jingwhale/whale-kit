...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/arrows/script.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch */ "sketch");
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sketch__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _createArrow_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createArrow.js */ "./src/arrows/createArrow.js");
/* harmony import */ var _updateArrow_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./updateArrow.js */ "./src/arrows/updateArrow.js");
/* harmony import */ var _utilities_getSourceObject_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utilities/getSourceObject.js */ "./src/arrows/utilities/getSourceObject.js");
/* harmony import */ var _utilities_data_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utilities/data.js */ "./src/arrows/utilities/data.js");
/* harmony import */ var _utilities_lines_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utilities/lines.js */ "./src/arrows/utilities/lines.js");
/* harmony import */ var _utilities_conditions_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utilities/conditions.js */ "./src/arrows/utilities/conditions.js");
//
//  Variables
//
    ...
    if (level == 1) {
      if (isUpdate) {// updateArrow(connectionsData[i].firstObject, connectionsData[i].secondObject, connectionsData[i].style, connectionsData[i].type, connectionsData[i].direction, connectionsData[i].line, connectionsData[i].condition, i);
        ...
        for (var _i3 = 0; _i3 < connectionsData.length; _i3++) {
          if (selection[0].objectID() == String(connectionsData[_i3].firstObject) || selection[0].objectID() == String(connectionsData[_i3].secondObject)) {
            if (selection[1].objectID() == String(connectionsData[_i3].firstObject) || selection[1].objectID() == String(connectionsData[_i3].secondObject)) {
...
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sketch */ "sketch");
/* harmony import */ var sketch__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sketch__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utilities_data_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities/data.js */ "./src/arrows/utilities/data.js");
/* harmony import */ var _utilities_lines_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utilities/lines.js */ "./src/arrows/utilities/lines.js");
...
/***/ "./src/arrows/utilities/getSourceObject.js":
/*!*************************************************!*\
  !*** ./src/arrows/utilities/getSourceObject.js ***!
  \*************************************************/
